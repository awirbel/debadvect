"""
    ...
    :param
    cmaxF               Courant-Friedrich-Levy condition parameter
    c_tol               concentration threshold for refinement
    decimals_mesh       round coordinates for mesh refinement to this degree (0 - only cut decimals, -1 - full tenths)
    c_VOL               threshold of maximum volume of refined cells in mesh
